...
texto = """
Soy Leonardo, un estudiante de quinto ciclo de Comunicación Audiovisual. Aunque mi pasión está en la producción y edición de contenido visual, aquí me encuentro lidiando con líneas de código. 
En este espacio verán reflexiones, gráficos y alguna que otra queja sobre el fascinante y, a veces, frustrante mundo de la programación.
Así que, si alguna vez has sentido que tu vida se convierte en un bucle infinito de depuración y más depuración, abróchate el cinturón y acompáñame en esta travesía. Aquí no hay finales felices garantizados, solo la promesa de que al menos intentaremos entender un poco más este mundo digital.
¡Disfruta (o sufre) la lectura!
"""
